...
require (
	...
	github.com/textileio/go-ds-mongo v0.1.5 // indirect
	github.com/textileio/go-libp2p-pubsub-rpc v0.0.5 // indirect
...
replace github.com/textileio/go-threads => github.com/textileio/go-threads v1.1.6-0.20220409162902-a715c2402413
